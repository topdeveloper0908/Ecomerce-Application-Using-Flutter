...
class CostumeCat extends StatefulWidget {
  const CostumeCat({Key? key}) : super(key: key);

  @override
  _PhoneCateState createState() => _PhoneCateState();
}

class _PhoneCateState extends State<CostumeCat>
    with SingleTickerProviderStateMixin {
  var costumecat = FirebaseFirestore.instance.collection("costume");
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getcostumefromfirebase(pattern);
                },
