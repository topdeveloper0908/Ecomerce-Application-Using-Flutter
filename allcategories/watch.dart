...
class SwatchCat extends StatefulWidget {
  const SwatchCat({Key? key}) : super(key: key);

  @override
  _WatchCatState createState() => _WatchCatState();
}

class _WatchCatState extends State<SwatchCat>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  var swatchcat = FirebaseFirestore.instance.collection("watches");
  var selectedindex = 0;
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getwatchfromfirebase(pattern);
                },
            ...
            if (snapshot.hasData) {
              return PageView.builder(
                  ...
                  itemBuilder: (
                    ...
                    Color? mycolor = Colors.red[100 * (index % 9)];
