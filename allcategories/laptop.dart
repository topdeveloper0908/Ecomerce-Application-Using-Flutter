...
class Lpatopcat extends StatefulWidget {
  const Lpatopcat({Key? key}) : super(key: key);

  @override
  _PhoneCateState createState() => _PhoneCateState();
}

class _PhoneCateState extends State<Lpatopcat>
    with SingleTickerProviderStateMixin {
  var laptopcat = FirebaseFirestore.instance.collection("laptop");
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getlaptopfromfirebase(pattern);
                },
