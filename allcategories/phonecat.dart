...
class PhoneCate extends StatefulWidget {
  const PhoneCate({Key? key}) : super(key: key);

  @override
  _PhoneCateState createState() => _PhoneCateState();
}

class _PhoneCateState extends State<PhoneCate>
    with SingleTickerProviderStateMixin {
  var phonecate = FirebaseFirestore.instance.collection("phone");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Icon(Entypo.app_store),
          centerTitle: true,
        ),
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getphonesfromfirebase(pattern);
                },
