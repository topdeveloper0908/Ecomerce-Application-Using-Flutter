...
class Dresscat extends StatefulWidget {
  const Dresscat({Key? key}) : super(key: key);

  @override
  _PhoneCateState createState() => _PhoneCateState();
}

class _PhoneCateState extends State<Dresscat>
    with SingleTickerProviderStateMixin {
  var robecat = FirebaseFirestore.instance.collection("robe");
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getrobefromfirebase(pattern);
                },
