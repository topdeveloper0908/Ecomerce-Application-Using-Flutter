...
class Chemisecat extends StatefulWidget {
  const Chemisecat({Key? key}) : super(key: key);

  @override
  _PhoneCateState createState() => _PhoneCateState();
}

class _PhoneCateState extends State<Chemisecat>
    with SingleTickerProviderStateMixin {
  var chemisecat = FirebaseFirestore.instance.collection("chemise");
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getchemisefromfirebase(pattern);
                },
