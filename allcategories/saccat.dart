...
class Saccat extends StatefulWidget {
  const Saccat({Key? key}) : super(key: key);

  @override
  _PhoneCateState createState() => _PhoneCateState();
}

class _PhoneCateState extends State<Saccat>
    with SingleTickerProviderStateMixin {
  var saccat = FirebaseFirestore.instance.collection("sac");
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getsacfromfirebase(pattern);
                },
