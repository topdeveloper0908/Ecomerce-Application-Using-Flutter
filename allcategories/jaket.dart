...
class JaketCat extends StatefulWidget {
  const JaketCat({Key? key}) : super(key: key);

  @override
  _PhoneCateState createState() => _PhoneCateState();
}

class _PhoneCateState extends State<JaketCat>
    with SingleTickerProviderStateMixin {
  var jaketCat = FirebaseFirestore.instance.collection("jaket");
          ...
          Container(
            ...
            child: TypeAheadField(
                ...
                suggestionsCallback: (pattern) async {
                  return await BackendService().getjeketfromfirebase(pattern);
                },
